...
var TeacherComponent = (function () {
    function TeacherComponent(loginService, router) {
        this.loginService = loginService;
        this.router = router;
    }
    TeacherComponent.prototype.beforeunloadHandler = function (event) {
...
], TeacherComponent.prototype, "beforeunloadHandler", null);
